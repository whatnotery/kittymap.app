...
Passwordless.success_redirect_path = root_path # When a user succeeds in logging in.
Passwordless.failure_redirect_path = root_path # When a a login is failed for any reason.
Passwordless.sign_out_redirect_path = root_path # When a user logs out.